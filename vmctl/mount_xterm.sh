...
#
# Assumes that there exists a /usr/local/lib directory and an empty file
# in /usr/local/bin/xterm
# TODO: Should we try to create the directory and file in this script ?
#
